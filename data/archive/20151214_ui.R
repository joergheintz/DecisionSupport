    ...
    fluidRow(
            ...
            wellPanel(
                tags$div(class = "row",
                    h4("Simplified ChIP-seq Pipeline and Recommended Software"),
                        ...
                        # tags$div(class = "span1", style="display:inline-block",
                        #          DT::dataTableOutput("decTable", height = "300px")
                        # ),
                        # tags$div(class = "span1", style="display:inline-block",
                        #          DT::dataTableOutput("benchdatatableout", height = "300px")
                        # )
                        # 
                        # tags$div(class = "span2", style="display:inline-block",
                        #          tabsetPanel(
        ...
        column(5,
               wellPanel(
                   tabsetPanel(
                       tabPanel(h6('Software Decision Support'),
                                DT::dataTableOutput("decTable", height = '290px')
                       ),
                       tabPanel(h6('Software Lineup'),
                                DT::dataTableOutput("benchdatatableout", height = '290px')
                       )
                   )
               )
        )
